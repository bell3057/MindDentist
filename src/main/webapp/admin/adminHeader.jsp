...
<div id="header-wrap">
	<div style="width: 1280px; height: 63px; padding-top: 30px;">
		...
		<a class="herder-box header-menu" href="../admin/adminBoardManagement">게시판 관리</a>
		<a class="herder-box header-menu" href="../admin/adminBannerManagement">배너 관리</a>
		<a class="herder-box header-menu" href="../admin/adminSlideManagement">슬라이드 관리</a>
		<!-- <a class="herder-box header-menu" href="../admin/adminBoardManagement">팝업 관리</a>
