...
#dImplant-text-3{
	...
	text-align: center;
	/* font: Bold 42px/60px NanumSquareRoundOTF; */
	font-family: 'NanumSquareRound',sans-serif;
	font-weight: bold;
	font-size: 42px;
	line-height: 60px;
...
#dImplant-text-4{
	text-align: center;
	/* font: Regular 36px/50px NanumSquareRoundOTF; */
	font-family: 'NanumSquareRound',sans-serif;
	font-size: 36px;
	line-height: 50px;
...
<div id="implant_wrap-5">
	<div style="width: 960px; height: 100%; margin: auto; padding-top: 130px;">
		...
		수립하며, 시술 후 적응기간에 나타날 수 잇는 불편함 까지 꼼꼼히 관리해 드립니다.</div>
	</div>
</div>
