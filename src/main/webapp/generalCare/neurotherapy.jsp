...
<div id="generalCare_wrap-3">
	<div class="top-bar top-bar1 topBarPC">
		...
		<div class="neGeneral-text-2">신경치료,
		...
		<div class="margin-bar margin-bar3"></div>
		<img class="neGeneral-img-5" src="../img/6-3/6305.png">
		<img class="neGeneral-img-6" src="../img/6-3/6306.png">
	</div>
	...
	<div class="top-bar top-bar1 topBarM">
		...
		자연치아를 살리기 위한
		최후의 방법입니다.</div>
		<div class="neGeneral-text-3">마인드치과에서는 자연치아를 최대한 살리는 것을
		원칙으로 합니다. 아무리 좋은 치료를 하더라도 자연치아
		만큼의 기능을 할 순 없습니다. 신경치료는 불편한 통증은
		최대한 빠르게 없애고, 자연치아의 기능을 최대한
		오래 유지하기 위한 치료입니다.</div>
		<div class="margin-bar margin-bar3"></div>
		<div class="neGeneral-text-4">신경치료 대상</div>
		<div style="margin-top: 42px; width: 303px; height: 220px;">
			<img class="neGeneral-img-3" src="../img/6-3/6301.png">
			<img class="neGeneral-img-3" src="../img/6-3/6302.png" style="margin-top: 20px;">
		</div>
		<div class="margin-bar margin-bar3"></div>
		<div class="neGeneral-text-4">마인드 신경치료 과정</div>
		<div style="margin-top: 50px; width: 320px; height: 485px;">
			<img class="neGeneral-img-4" src="../img/6-3/6303.png">
			<img class="neGeneral-img-4" src="../img/6-3/6304.png" style="margin-top: 4px;">
		</div>
		<div class="neGeneral-text-3" style="margin-top: 41px;">사람마다 치아의 모양과 신경의 구조는 모두 다릅니다.
		치아 뿌리가 휘어져 있는 경우 신경치료 기구가 쉽게 도달하지
		못해 치료가 어렵고, 신경관이 막혀 있는 경우에는 치료를
		해보지도 못한 채 발치 하는 경우도 많습니다.
		
		마인드치과에서는 놓치기 쉬운 신경관을 찾아내기 위해
		신경치료용 확대 루페를 사용하고 있습니다.
		발견하기 어려운 신경관까지 찾아내 말끔히 치료해드립니다.</div>
		<div class="margin-bar margin-bar3"></div>
		<img class="neGeneral-img-5" src="../img_m/6/6305.png">
		<img class="neGeneral-img-6" src="../img_m/6/6306.png">
	</div>
</div>
