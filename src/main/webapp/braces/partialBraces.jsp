...
<div id="braces_wrap-5">
	<div class="top-bar top-bar4 topBarPC">
		...
		<div class="paBraces-text-2">“교정은 오래 걸린다? NO!”
		마인드의 노하우로 완성하는 더 빠르고 경제적인 부분교정</div>
		<div class="margin-bar margin-bar5" ></div>
		<img class="paBraces-img-3" src="../img/4-5/4501.png">
		<div class="paBraces-text-3">교정이 필요한 부분이 한정적일 경우에는 전체교정이
		...
		<div class="margin-bar margin-bar5"></div>
		<div class="paBraces-text-4"><span style="font-weight: bold; color: #C8500F">부분교정 장치는 기존의 교정장치에 비해 사이즈가 작아 이물감이 적고,
		겉으로 많이 드러나지 않아 심미성이 뛰어납니다.</span>
		
		필요한 부분만 빠르게 개선할 수 있어
		많은 분들이 선호하는 효율적인 교정방식입니다.</div>
		<img class="paBraces-img-4" src="../img/4-5/4502.png">
		<img class="paBraces-img-5" src="../img/4-5/4503.png">
	</div>
	...
	<div class="top-bar top-bar4 topBarM">
		...
		더 빠르고 경제적인 부분교정</div>
		<div class="margin-bar margin-bar5" ></div>
		<img class="paBraces-img-3" src="../img_m/4/4501.png">
		<div class="paBraces-text-3">교정이 필요한 부분이 한정적일 경우에는 전체교정이 아닌
		부분교정을 진행하는 것이 합리적입니다.
		
		치아 상태에 따라 다양한 장치를 선택적으로 사용할 수
		있으며, 특히 설측으로(치아 안쪽)하는 부분교정은
		빠른 치료기간과 보이지 않는 심미성,
		금액적인 경제성까지 얻을 수 있는 방법입니다.</div>
		<div class="margin-bar margin-bar5"></div>
		<div class="paBraces-text-4"><span style="font-weight: bold; color: #C8500F">부분교정 장치는 기존의 교정장치에 비해 사이즈가 작아
		이물감이 적고, 겉으로 많이 드러나지
		않아 심미성이 뛰어납니다.</span>
